...
<div id="headerBlock" class="page-header <% if not $Image %>header-small<% end_if %><% if $BackgroundImage %>header-filter<% end_if %>" style="<% if $BackgroundColor %>background-color:#{$BackgroundColor};<% end_if %> <% if $BackgroundImage %>background-image:url('$BackgroundImage.Link');<% end_if %>;">
	<div class="container">
        <div class="row">
            <div class="col-md-<% if $Image %>7<% else %>12 <% end_if %> <% if $Alignment == 'Center' %>text-center<% end_if %>">
                <div class="brand">
